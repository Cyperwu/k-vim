# forked from [k-vim](https://github.com/wklken/k-vim)
...
```
git clone https://github.com/Cyperwu/k-vim.git
```
...
# 如果发现有插件安装失败 可以进入vim, 执行`:call dein#install()'
...
```
:call dein#install() install                      安装插件
:DeinUpdate install or update            更新插件
```
